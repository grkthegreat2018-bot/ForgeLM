...
Usage:
    from forge.moe.airmoe_hotswap import AirMoEHotswapLoader, TopicRouter
...
class AirMoEHotswapLoader:
    ...
    def inject_kv_cache(self, input_ids: torch.Tensor) -> torch.Tensor | None:
        ...
        try:
            from forge.keys.knowledge.knowledge_pack_key import KnowledgePack
