...
def run_phase2(src: str, config: str = "qwen25_coder_1.5b",
    ...
    if use_gateskip:
        ...
        from research.architecture.gateskip import GateSkipBlock
    ...
    if use_mtp:
        ...
        from research.decoding.mtp import MTPHead
    ...
    if use_spinquant:
        ...
        from research.quantization.spinquant import SpinQuantizer
