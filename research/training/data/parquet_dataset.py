...
Usage (converter)::
    ...
    from research.training.data.parquet_dataset import convert_jsonl_to_parquet
    convert_jsonl_to_parquet("data.jsonl", "data.parquet")

Usage (training)::

    from research.training.data.parquet_dataset import ParquetDataset, StreamingDataLoader
...
def convert_jsonl_to_parquet_tokenized(
    ...
    """
    from research.training.runners.sft_train import (
        _tokenize_cached,
        tokenize_example,
        load_examples,
    )
