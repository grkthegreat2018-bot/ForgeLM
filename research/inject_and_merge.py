...
class InjectMergePipeline:
    ...
    def __init__(self, target_checkpoint: str, config_name: str = "forgelm_v7",
...
def main():
    ...
    p.add_argument("--config", default="forgelm_v7",
                   help="Model config name (lfm25_1.2b, lfm25_tiny, forgelm_v7, forgelm_v7)")
