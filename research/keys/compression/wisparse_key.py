...
class WiSparseExpert:
    ...
    def forward(self, x):
        ...
        with torch.no_grad():
            ...
            try:
                from research.keys.compression.wisparse_triton import wisparse_fused
...
class WiSparseKey(Key):
    ...
    def apply(self, model: nn.Module) -> int:
        ...
        _triton_fn = None
        try:
            from research.keys.compression.wisparse_triton import wisparse_fused as _triton_fn
