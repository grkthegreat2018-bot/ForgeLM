...
DSHARK_SAVE_PATH = _paths.as_str(_paths.DSPARK_HEAD_PATH)
DEFAULT_DATA = _paths.as_str(_paths.ALL_TEACHERS_V2_SCORED)
...
def train_dspark(data_path: str, epochs: int, lr: float, batch_size: int,
    ...
    try:
        from research.keys.speculative.dspark_key import init_dspark_from_model
