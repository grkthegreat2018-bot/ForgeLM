...
def test_tensor_dedup():
    ...
    from research.keys.compression.tensor_dedup_key import TensorDedupKey, apply_tensor_dedup, restore_aliases
...
def test_combined():
    ...
    from research.keys.compression.tensor_dedup_key import TensorDedupKey, restore_aliases
